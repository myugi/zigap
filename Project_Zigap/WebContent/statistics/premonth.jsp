...
<jsp:include page="../menu_top.jsp" flush="true"></jsp:include>
   ...
   <!--계좌 리스트 -->
   <br>
      <h2 class="form-signin-heading">전월대비 <%=incmExp%> 현황</h2>
   <br>
  		<form class="form-search" name="searchForm" action="premonth.stat">
      ...
      <table id="list" class="table table-hover">
         <tr id = "tr_top">
            ...
            <td class="td-label"><label>전월 <%=amtNm%></label></td>
            <td class="td-label"><label>당월 <%=amtNm%></label></td>
            <td></td>
         </tr>
         <%
         if(list != null){
         %>   
            ...
            <tr>
               ...
               <td class="td-board"><font><%=StringUtil.numberFormat(list.get(i).getPRE_AMT()) %></font></td>
               <td class="td-board"><font style="color: <%=list.get(i).getCOLOR() %>"><%=StringUtil.numberFormat(list.get(i).getCUR_AMT()) %></font></td>
            </tr>
         <%} %>
      </table>
