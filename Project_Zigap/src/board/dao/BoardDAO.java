...
public class BoardDAO {
	...
	//글 목록 보기
	public ArrayList<BoardBean> selectArticleList(int page, int limit, String search, String combo){
		
		String board_list_sql = "";
		PreparedStatement pstmt = null;
		ResultSet rs = null;

		if(combo.equals("BOARD_SUBJECT") || combo.equals("")) {
			board_list_sql = "select * from board where BOARD_SUBJECT like ? order by BOARD_RE_REF desc, BOARD_RE_SEQ asc limit ?,?";
		}else if(combo.equals("BOARD_NAME")){
			board_list_sql = "select * from board where BOARD_NAME like ? order by BOARD_RE_REF desc, BOARD_RE_SEQ asc limit ?,?";			
		}
